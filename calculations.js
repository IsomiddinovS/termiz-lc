...
// -------------------------------------------------------
// HISOB-KITOB PANELI: Xaversine bosqichlarini ajratib qaytarish
// (natijalarni o'zgartirmaydi, faqat ko'rsatish uchun)
// -------------------------------------------------------
function xaversineQadamlar(lat1, lon1, lat2, lon2) {
    const R = 6371;
    const dLat = ((lat2 - lat1) * Math.PI) / 180;
    const dLon = ((lon2 - lon1) * Math.PI) / 180;
    const a =
    ...
    return { R, lat1, lon1, lat2, lon2, dLat, dLon, a, c, masofa: R * c };
}
